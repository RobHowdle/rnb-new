                ...
                <div class="audio-grid mt-2">
                    <div class="player">
                        ...
                        <div class="record-player">
                            ...
                            <div class="overlay">
                                <img class="record-img" src="media/img/record.png">
                        ...
                        <div class=" swiper-wrapper">
                            <div class="swiper-slide" data-track-index="0">
                                ...
                                <div class="overlay text-center">
                                    <p class="slider-overlay--small">Now Playing</p>
                                    <p class="slider-overlay--main">All My Life</p>
                                    <p class="slider-overlay--small">By</p>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const recordImage = document.querySelector('.record-player .overlay .record-img');
        const visWrapper = document.querySelector('.record-player .overlay .viswrapper');
        const imageWidth = recordImage.clientWidth;
        const imageHeight = recordImage.clientHeight;
